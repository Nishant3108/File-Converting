...
public class CsvWriter {
     ...
     * into CSV format
     */
    public static void writeCSVFile(Element secondTable) {
        try {
            ...
            ///////////////////////////////////////////////
            FileWriter newCSVDocument = new FileWriter("C:/JAVA_PROGRAMS/FinalProject/outputDocument.csv");
            try (CSVPrinter csvPrinter = new CSVPrinter(newCSVDocument, CSVFormat.DEFAULT)) {
                ...
                csvPrinter.flush();
                System.out.println("CSV file created at outputDocument.csv.");
