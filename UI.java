...
import javafx.geometry.Insets;////manage spacing between layouts
...
//import java.awt.Desktop;//interaction with desktop application
...
public class UI extends Application {
    ...
    // private Desktop desktop = Desktop.getDesktop(); // provides access to desktop
    ...
    public void start(Stage primaryStage) {
        ...
        startButton.setOnAction(e -> {
            if (uploadedFile != null && downloadFolder != null) {
                ...
                showAlert(Alert.AlertType.INFORMATION, "Processing", "Processing file...\nUploaded file: "
                        + uploadedFile.getAbsolutePath() + "\nDownload folder: " + downloadFolder.getAbsolutePath());
            } else {
